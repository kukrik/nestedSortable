...
class HomePageMetadataPanel extends \QCubed\Control\Panel
{
    public $lblMessage;
    ...
    public function __construct($objParentObject, $strControlId = null)
    {
        ...
        $this->lblKeywordsHint = new Q\Plugin\Alert($this);
        ...
        $this->lblDescriptionHint = new Q\Plugin\Alert($this);
        ...
        $this->lblAuthorHint = new Q\Plugin\Alert($this);
