...
class NewsEditPanel extends Q\Control\Panel
{
    ...
    public function __construct($objParentObject, $strControlId = null)
    {
        ...
        $this->modal1->Text = t('<p style="line-height: 25px; margin-bottom: 2px;">Kas oled kindel, et soovid selle uudise sektsiooni kustutada?</p>
    ...
    public function btnMenuSave_Click(ActionParams $params)
    {
        if ($this->txtMenuText->Text) {
            ...
            $this->lblMessage->Text = t('<strong>Sorry</strong>, the menu title and news type must exist!');
        }
    }
