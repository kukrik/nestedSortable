...
class SampleForm extends Form
{
    ...
    protected function formCreate()
    {
        ...
        $this->pnl->addStatusButton(
            [t('Enable'), t('Disable')],
            ['btn btn-success btn-xs', 'btn btn-white btn-xs'],
            null,
            //'fa fa-pencil',
            false,
            true,
        ...
        $this->pnl->addButton(t('Edit'), 'btn btn-darkblue btn-xs', 'fa fa-pencil', true, false, 'btnMenuEdit_Click');

        $this->pnl->addButton(t('Delete'), 'btn btn-danger btn-xs', 'fa fa-pencil', true, false);
