...
class SampleForm extends Form
{
    ...
    protected function formCreate()
    {
        ...
        $this->pnl->addStatusButton([t('Enable'), t('Disable')], ['btn btn-success btn-xs', 'btn btn-white btn-xs'], null, false);
        //$this->pnl->addAction(new Q\Event\Click(), new Q\Action\Ajax('btnMenuStatus_Click'));

        $this->pnl->addEditButton(t('Edit'), 'btn btn-darkblue btn-xs', 'fa fa-pencil', true, false);

        $this->pnl->addDeleteButton(t('Delete'), 'btn btn-danger btn-xs', 'fa fa-trash', true, false);
    ...
    {
        Application::redirect("http://localhost/qcubed-4/project/forms/address_list.php");
    }*/
