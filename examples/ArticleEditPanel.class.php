...
class ArticleEditPanel extends Panel
{
    ...
    public function __construct($objParentObject, $strControlId = null)
    {
        ...
        $this->lblCategory = new Q\Plugin\Label($this);
        ...
        //$this->txtContent->TextMode = Q\Control\TextBoxBase::MULTI_LINE;
        ...
        if (!$this->objArticle->Picture) {
            $this->lblPictureDescription = new Q\Plugin\Label($this);
            $this->lblPictureDescription->Text = t('Picture description');
            $this->lblPictureDescription->setCssStyle('margin-bottom', '15px;');

            $this->txtPictureDescription = new Bs\TextBox($this);
            $this->txtPictureDescription->Text = $this->objArticle->PictureDescription;
            $this->txtPictureDescription->MaxLength = Article::PictureDescriptionMaxLength;
        ...
        $this->lblConfirmationAsking = new Q\Plugin\Label($this);
        $this->lblConfirmationAsking->Text = t('Confirmation of publication');

        $this->chkConfirmationAsking = new Q\Plugin\Checkbox($this);
    ...
    public function lstCategory_GetItems()
    {
        ...
        $objCategoryCursor = Category::queryCursor($objCondition, $this->objCategoryClauses);
    ...
    public function btnMenuSave_Click(ActionParams $params)
    {
        if ($this->txtMenuText->Text && $this->txtTitle->Text) {
            ...
            $this->lblMenuText->Text = $this->txtMenuText->Text;
            ...
            $this->lblMessage->Text = t('<strong>Sorry</strong>, the menu title or content title must exist!');
        }
    }
